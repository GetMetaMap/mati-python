...
def test_api_service_v1_validate_signature_no_secret():
    api_service = ApiServiceV1()
    api_service.init(client_id, client_secret)
...
def test_api_service_v1_validate_signature_wrong_signature():
    api_service = ApiServiceV1()
    api_service.init(client_id, client_secret, webhook_secret)
    result = api_service.validate_signature(
        'wrong sig',
...
@pytest.mark.vcr
def test_api_service_v1_fetch_resource():
    assert fetch_resource()


@pytest.mark.vcr
def test_api_service_v1_fetch_resource_with_401_error():
